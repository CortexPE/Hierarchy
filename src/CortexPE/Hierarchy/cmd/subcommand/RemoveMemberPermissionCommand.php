...
class RemoveMemberPermissionCommand extends SubCommand {
	public function __construct(
		...
		$this->setPermission("hierarchy.member.remove_permission");
	}
	...
	public function execute(CommandSender $sender, array $args): void {
		if(count($args) === 2) {
			...
			if($permission !== null) {
				...
				$sender->sendMessage(MessageStore::getMessage("cmd.remove_m_perm.success", [
